...
public final class mediaExcelDao_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/dashboard/media/../../riskv3/inc/sessioncheck.jsp");
  }
...
if("1".equals(section)){	
	...
	JSONArray mList = mMgr.getPublicityTrend(sDate,eDate,scope,keyword,pcode);
      ...
      out.write("\t\t\t<th scope=\"col\"><span>정보량</span></th>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</thead>\r\n");
      out.write("\t    <tbody>\r\n");
      ...
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<td><span>");
      out.print(obj.get("fulldate"));
      out.write("</span></td>\t\t\t\r\n");
      out.write("\t\t\t<td><span>");
      out.print(obj.getString("column-1"));
      out.write("</span></td>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t");
	...
	JSONArray mList = mMgr.getChannelInfo(sDate,eDate,scope,keyword,pcode);
      ...
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t<th scope=\"col\"><span>채널</span></th>\t\t\t\r\n");
      out.write("\t\t\t<th scope=\"col\"><span>정보량</span></th>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</thead>\r\n");
      ...
      out.write("</span></td>\t\t\t\r\n");
      out.write("\t\t\t<td><span>");
      out.print(obj.getString("column_1"));
      out.write("</span></td>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t");
	...
	JSONArray mList = mMgr.getRealstateGraph(sDate, eDate, scope, keyword, pcode);
      ...
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t<th scope=\"col\"><span>실국</span></th>\t\t\t\r\n");
      out.write("\t\t\t<th scope=\"col\"><span>정보량</span></th>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</thead>\r\n");
	...
	JSONArray mList = mMgr.getRealstateInfo_Excel(sDate, eDate, scope, keyword, pcode);
      ...
      out.write("</span></td>\t\t\t\r\n");
      out.write("\t\t\t<td><span>");
      out.print(obj.getString("site_name"));
      out.write("</span></td>\r\n");
      out.write("\t\t\t<td><span>");
      out.print(obj.getString("title"));
      out.write("</span></td>\r\n");
      out.write("\t\t\t<td><span>");
      out.print(obj.getString("url"));
      out.write("</span></td>\r\n");
      out.write("\t\t\t<td><span>");
      out.print(obj.getString("type5"));
      out.write("</span></td>\r\n");
      out.write("\t\t\t<td><span>");
      out.print(obj.getString("type51"));
      out.write("</span></td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t");
