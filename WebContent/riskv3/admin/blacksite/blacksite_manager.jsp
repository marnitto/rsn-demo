...
<%
	...
	String order = pr.getString("order", "BS_KEYWORD ASC");	//정렬 순서
...
<!--
	...
	{				
		...
		if(mode=='update')
		{
			popup.openByPost('managerForm','blacksite_edit.jsp',500,155,false,false,false,'trendPop');
		}else{
			popup.openByPost('managerForm','blacksite_add.jsp',500,155,false,false,false,'trendPop');
		}
		...
		<table align="center" style="width:820px;" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td><img src="../../../images/admin/aekeyword/tit_icon.gif" /><img src="../../../images/admin/aekeyword/tit_0505.gif" /></td>
						<td align="right">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td class="navi_home">HOME</td>
								<td class="navi_arrow">관리자</td>
								<td class="navi_arrow2">블랙사이트관리</td>
							</tr>
						</table>
						</td>
					</tr>
