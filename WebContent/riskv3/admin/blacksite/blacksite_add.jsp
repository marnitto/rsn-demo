...
<table style="width:100%;" border="0" cellpadding="0" cellspacing="10">
	<tr>
		<td id="pop_head"><font color="white" style="border:white; font-weight:bolder; font-size:15px">&nbsp;&nbsp;블랙사이트 등록</font>
...
<table style="width:100%;" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td style="padding-left:10px"><table width="470" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width="80" align="left" style="padding: 3px 0px 0px 0px;" class="menu_gray"><strong>URL주소 :</strong></td>
			<td width="390" align="left" style="padding: 3px 0px 0px 0px;"><input type="text" name="ekValue" value="" size=50></td>
		</tr>
	</table></td>
	</tr>
</table>
