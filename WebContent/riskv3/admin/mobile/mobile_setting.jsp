...
<%
	...
	// 세팅 정보 가져오기 Type = 2 mobile alimi setting
...
<SCRIPT LANGUAGE="JavaScript">
	...
	function save(){
		...
		document.mobileSend.action = 'mobile_setting.jsp';
...
<table width="780" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td background="../images2/top_title_bg.gif"><img src="../images/admin_title_08.gif" ></td>
    <td align="right" background="../images2/top_title_bg.gif" class="menu_gray" style="padding: 0px 10px 0px 0px;">앱 알리미 조건을 관리합니다.</td>
  </tr>
  <tr>
