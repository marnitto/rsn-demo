...
$(function(){
	getMailReceiverList();	//SMS 수신자 전체 목록 가져오기
	loading();
});
...
<body>
	...
	<input type="hidden" name="mode" value="sms"><!-- SMS발송 모드 -->
	<input type="hidden" name="ir_type" value="E"><!-- 긴급보고서 타입-->
	<input type="hidden" name="id_seq" value="<%=check_no%>"> <!-- 기사 -->
	<input type="hidden" name="mailreceiver" value=""><!-- SMS 대상자 -->
	<input type="hidden" name="asSeq" /><!-- SMS수신자 그룹 -->
		<!-- SMS 발송 목록 -->
		<div class="article m_t_10">
			<h3><span class="icon">-</span>SMS 발송 이슈</h3>
			<div class="ui_table_02">
				<table summary="SMS 발송 목록">
				<caption>SMS 발송 목록</caption>
				<colgroup>
		...
		<div class="article m_t_20">
			<h3><span class="icon">-</span>SMS 발송 설정</h3>
			<table class="ui_multiselector_box_00" summary="SMS 수신자/대상자 설정">
			<caption>SMS 수신자/대상자 설정</caption>
			<colgroup>
				<col>
