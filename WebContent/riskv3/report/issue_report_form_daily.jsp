...
<%
	...
	//일일 보고서 관련
	today = du.getCurrentDate("M월dd일 E요일");
	...
	//차트1번
	//arrGdataA = iMgr.channelTrendChartData_Keyword("10", ir_sdate,ir_stime,ir_edate,ir_etime);
	arrGdataA = iMgr.channelTrendChartData_TYPE15("15", ir_sdate,ir_stime,ir_edate,ir_etime);
	chart1 = irChart.makeStackBar(1, arrGdataA, "Chart1"+du.getCurrentDate("yyyyMMddHHmmss"), filePath, chartUrl, 359, 217, "vertical", "percentage");
	
	//차트2번
	arrGdataB = iMgr.BarChartData("6", ir_sdate,ir_stime,ir_edate,ir_etime);
	chart2 = irChart.makeBar(1, arrGdataB, "Chart2"+du.getCurrentDate("yyyyMMddHHmmss"), filePath, chartUrl, 375, 208);
	
	//차트3번
	arrGdataC = iMgr.TrendPieChartData("13", ir_sdate,ir_stime,ir_edate,ir_etime);
	chart3 = irChart.make3DPieChart(1, arrGdataC, "Chart3"+du.getCurrentDate("yyyyMMddHHmmss"), filePath, chartUrl, 237, 153);//237
	
	//차트4번
	arrGdataD = iMgr.TrendPieChartData("9", ir_sdate,ir_stime,ir_edate,ir_etime);
	chart4 = irChart.make3DPieChart(1, arrGdataD, "Chart4"+du.getCurrentDate("yyyyMMddHHmmss"), filePath, chartUrl, 195, 146);
	
	//차트5번
	arrGdataE = iMgr.channelTrendChartData_TEMP("6", ir_sdate,ir_stime,ir_edate,ir_etime);
	chart5 = irChart.makeStackBar(1, arrGdataE, "Chart5"+du.getCurrentDate("yyyyMMddHHmmss"), filePath, chartUrl, 283, 161, "vertical", "percentage");
...
<table width="750" border="0" cellpadding="0" cellspacing="1" bgcolor="DADADA">
  <tr>
    <td bgcolor="#FFFFFF"><table width="748" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><img src="<%=imgUrl%>top_img.jpg" width="748" height="75" /></td>
      </tr>
      <tr>
        <td height="28" align="right" background="<%=imgUrl%>bg_date.gif" style="padding:0px 10px 0px 0px">
        <table width="730" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="300" class="t_text" style="padding:0px 0px 0px 10px"><img src="<%=imgUrl%>emer_icon.gif" width="10" height="10" /> 본 내용은 대외비로 보안에 유의하시기 바랍니다.</td>
            <td width="430" align="right"><img src="<%=imgUrl%>icon_clock.gif" width="12" height="13" align="absmiddle" /> <%=formatSdate%> ~ <%=formatEdate%> (발송일 : <%=today%>)</td>
          </tr>
        </table>
        </td>
      </tr>
      ...
      <tr>
        <td><table width="710" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td><table width="710" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><img src="<%=imgUrl%>title_01.gif"  /></td>
              </tr>
              <tr>
                <td height="4"></td>
              </tr>
              ...
              <%} %>
                ...
                <td><table width="710" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td background="<%=imgUrl%>write_bg_02.gif" style="padding:10px 10px 8px 18px">... <br />
                      ... <br />
                      ...</td>
                  </tr>
                  <tr>
...
<!--                            <td width="90" align="center" bgcolor="F5F5F5"><strong> 유사수량</strong></td>-->
                          </tr>
                    ...
                    <tr>
                      <td><table width="710" border="0" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
                          <tr>
                            ...
                            <td width="312" align="center" bgcolor="F5F5F5"><strong>제목</strong></td>
                            ...
                            <td width="74" align="center" bgcolor="F5F5F5"><strong>유사수량</strong></td>
          ...
          <tr>
            <td><table width="710" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><img src="<%=imgUrl%>title_02.gif"  /></td>
              </tr>
              <tr>
                <td height="4"></td>
              </tr>
                  ...
                  <tr>
                    <td><table width="200" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td background="<%=imgUrl%>tap_01_01.gif" class="w_text" style="padding:2px 0px 0px 10px"><strong>정보 그룹별 성향</strong></td>
                        <td width="28"><img src="<%=imgUrl%>tap_01_02.gif" width="28" height="29" /></td>
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
                    <td><img src="<%=imgUrl%>tap_bg_01.gif" width="710" height="6" /></td>
                  </tr>
                  <tr>
                    <td background="<%=imgUrl%>tap_bg_02.gif" style="padding:15px 0px 15px 0px"><table width="680" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="272" valign="top"><table width="272" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="2" bgcolor="6A90C8"></td>
                          </tr>
                          <tr>
                            <td><table width="272" border="0" cellpadding="0" cellspacing="1" bgcolor="CCCCCC">
                              <tr>
                                <td width="78" height="25" align="center" bgcolor="#E9EDF4"><strong>구분</strong></td>
                                <td width="47" align="center" bgcolor="#E9EDF4"> <strong>긍정</strong></td>
                                <td width="47" align="center" bgcolor="#E9EDF4"> <strong>부정</strong></td>
                                <td width="47" align="center" bgcolor="#E9EDF4"> <strong>중립</strong></td>
                                <td width="47" align="center" bgcolor="#E9EDF4"> <strong>합계</strong></td>
                              </tr>
                              <%
                              	
                              	for(int i =0; i < arrGdataA.size(); i ++){
                            		hm = (HashMap)arrGdataA.get(i);
                            		
                              %>
                              <tr>
                                <td height="22" align="center" bgcolor="#FFFFFF"><%=hm.get("CATEGORY")%></td>
                                <td align="center" bgcolor="#FFFFFF"><%=hm.get("PCNT")%></td>
                                <td align="center" bgcolor="#FFFFFF"><%=hm.get("NCNT")%></td>
                                <td align="center" bgcolor="#FFFFFF"><%=hm.get("ECNT")%></td>
                                <td align="center" bgcolor="#F7F7F7"><%=Integer.parseInt((String)hm.get("PCNT"))+Integer.parseInt((String)hm.get("NCNT"))+Integer.parseInt((String)hm.get("ECNT"))%></td>
                              </tr>
                        ...
                        <td width="382" align="center"><img src="<%=chart1%>"  /></td>
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
                    <td><img src="<%=imgUrl%>tap_bg_03.gif" width="710" height="6" /></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
          ...
          <tr>
            <td><table width="710" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><img src="<%=imgUrl%>title_03.gif" /></td>
              </tr>
              <tr>
                <td height="4"></td>
              </tr>
                ...
                <td height="6"><table width="710" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><table width="260" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="6" height="29"><img src="<%=imgUrl%>tap_01.gif" width="6" height="29" /></td>
                            <td background="<%=imgUrl%>tap_01_01.gif" class="w_text" style="padding:2px 0px 0px 10px"><strong>온라인 채널별 수량 및 유형 분석</strong></td>
                            <td width="28"><img src="<%=imgUrl%>tap_01_02.gif" width="28" height="29" /></td>
                          </tr>
                      </table></td>
                    </tr>
                      ...
                      <td background="<%=imgUrl%>tap_bg_02.gif"><table width="706" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><table width="706" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="275" background="<%=imgUrl%>table_bg_01.gif"style="padding:0px 0px 0px 18px"><img src="<%=imgUrl%>arrow.gif" width="10" height="7" /><strong>채널별 수량</strong></td>
                              <td width="1"><img src="<%=imgUrl%>line.gif" width="1" height="32" /></td>
                              <td width="430" height="32" background="<%=imgUrl%>table_bg_01.gif" style="padding:0px 0px 0px 18px"><img src="<%=imgUrl%>arrow.gif" width="10" height="7" /><strong>온라인 수량</strong></td>
                            </tr>
                          </table></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td><table width="706" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="275" align="center" style="padding:15px 0px 15px 0px"><table width="237" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td height="2" bgcolor="6A90C8"></td>
                                </tr>
                                <tr>
                                  <td><table width="237" border="0" cellpadding="0" cellspacing="1" bgcolor="CCCCCC">
                                      <tr>
                                        <td width="97" height="30" align="center" bgcolor="#E9EDF4"><strong>채널</strong></td>
                                        <td width="67" align="center" bgcolor="#E9EDF4"><strong> 수량</strong></td>
                                        <td width="69" align="center" bgcolor="#E9EDF4"><strong> 총합</strong></td>
                                        </tr>
                                      <%
                                      	int sum =0;
                                      	for(int i =0; i < arrGdataB.size(); i ++){
                                    		hm = (HashMap)arrGdataB.get(i);
                                    		sum += Integer.parseInt((String)hm.get("CNT"));
                                      	}
                                      ...
                                      %>  
                                      <tr>
                                        <td height="30" align="center" bgcolor="#FFFFFF"><%=hm.get("CATEGORY")%></td>
                                        <td align="center" bgcolor="#FFFFFF"><%=hm.get("CNT")%></td>
                                        <%if(i == 0){ %>	
                                        <td rowspan="<%=arrGdataB.size()%>" align="center" bgcolor="#F7F7F7"><%=sum%></td>
                                        <%} %>
                                     </tr>
                                      <%} %> 
                                  </table></td>
                              ...
                              <td width="420" height="32" align="center" style="padding:15px 0px 15px 0px"><img src="<%=chart2%>" /></td>
                            </tr>
                          </table></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td><table width="706" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="275" background="<%=imgUrl%>table_bg_01.gif"style="padding:0px 0px 0px 18px"><img src="<%=imgUrl%>arrow.gif" width="10" height="7" /><strong>유형별 수량</strong></td>
                              <td width="1"><img src="<%=imgUrl%>line.gif" width="1" height="32" /></td>
                              <td width="430" height="32" background="<%=imgUrl%>table_bg_01.gif" style="padding:0px 0px 0px 18px"><img src="<%=imgUrl%>arrow.gif" width="10" height="7" /><strong>성향별 수량</strong></td>
                            </tr>
                          </table></td>
                        </tr>
                        <tr>
                            ...
                            <tr>
                              <td width="275" align="center" style="padding:15px 0px 15px 0px"><table width="237" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    <td><table width="237" border="0" cellpadding="0" cellspacing="1" bgcolor="CCCCCC">
                                        <tr>
                                          <td width="97" height="30" align="center" bgcolor="#E9EDF4"><strong>여론유형</strong></td>
                                          <td width="67" align="center" bgcolor="#E9EDF4"><strong> 수량</strong></td>
                                          <td width="69" align="center" bgcolor="#E9EDF4"><strong> 총합</strong></td>
                                        </tr>
                                        <%
                                      		sum =0;
                                      		for(int i =0; i < arrGdataC.size(); i ++){
                                    			hm = (HashMap)arrGdataC.get(i);
                                    			sum += Integer.parseInt((String)hm.get("CNT"));
                                      		}
                                        ...
                                        <tr>
                                          ...
                                          <td align="center" bgcolor="#FFFFFF"><%=hm.get("CNT")%></td>
                                          <%if(i == 0){ %>
                                          <td rowspan="<%=arrGdataC.size()%>" align="center" bgcolor="#F7F7F7"><%=sum%></td>
                                          <%} %>
                                        </tr>
                                        <%	} %>
                                    </table></td>
                              ...
                              <td width="1" background="<%=imgUrl%>line.gif"><img src="<%=imgUrl%>line.gif" width="1" /></td>
                              <td width="420" height="32" align="center" style="padding:15px 0px 15px 0px"><img src="<%=chart3%>"  /></td>
                            </tr>
                          </table></td>
                        </tr>
                      </table></td>
                ...
                <td><table width="710" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><table width="310" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="6" height="29"><img src="<%=imgUrl%>tap_01.gif" width="6" height="29" /></td>
                          <td background="<%=imgUrl%>tap_01_01.gif" class="w_text" style="padding:2px 0px 0px 10px"><strong>온라인 성향별 수량 및 채널별 성향 분석</strong></td>
                          <td width="28"><img src="<%=imgUrl%>tap_01_02.gif" width="28" height="29" /></td>
                        </tr>
                    </table></td>
                  </tr>
                  ...
                  <tr>
                    <td background="<%=imgUrl%>tap_bg_02.gif"><table width="706" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><table width="706" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="384" height="32" background="<%=imgUrl%>table_bg_01.gif" style="padding:0px 0px 0px 18px"><img src="<%=imgUrl%>arrow.gif" width="10" height="7" /><strong>노출여론 성향</strong></td>
                                <td width="1"><img src="<%=imgUrl%>line.gif" width="1" height="32" /></td>
                                <td width="316" background="<%=imgUrl%>table_bg_01.gif"style="padding:0px 0px 0px 18px"><img src="<%=imgUrl%>arrow.gif" width="10" height="7" /><strong>채널별 성향</strong></td>
                              </tr>
                          </table></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td><table width="706" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="385" height="32" align="center" style="padding:15px 0px 15px 0px"><table width="355" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="147"><table width="150" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td height="2" bgcolor="6A90C8"></td>
                                      </tr>
                                      <tr>
                                        <td><table width="150" border="0" cellpadding="0" cellspacing="1" bgcolor="CCCCCC">
                                            <tr>
                                              <td width="84" height="30" align="center" bgcolor="#E9EDF4"><strong>성향</strong></td>
                                              <td width="63" align="center" bgcolor="#E9EDF4"><strong> 수량</strong></td>
                                              </tr>
                                              <%
	                                      		sum = 0;
	                                    	  	for(int i =0; i < arrGdataD.size(); i ++){
	                                      			hm = (HashMap)arrGdataD.get(i);
	                                      			sum += Integer.parseInt((String)hm.get("CNT"));
		                                       %>
                                            <tr>
                                              <td height="30" align="center" bgcolor="#FFFFFF"><%=hm.get("CATEGORY")%></td>
                                            ...
                                            <%	} %>
                                            <tr>
                                              <td height="30" align="center" bgcolor="#F7F7F7">금일총합</td>
                                              <td align="center" bgcolor="#F7F7F7"><%=sum%></td>
                                             </tr>
                                        </table></td>
                                      </tr>
                                    </table>
                                    ...
                                    <td width="10">&nbsp;</td>
                                    <td width="195"><img src="<%=chart4%>" /></td>
                                  </tr>
                                </table></td>
                                <td width="1" background="<%=imgUrl%>line.gif"><img src="<%=imgUrl%>line.gif" width="1" /></td>
                                <td width="320" align="center" style="padding:15px 0px 15px 0px"><img src="<%=chart5%>" /></td>
                              </tr>
                          </table></td>
                        </tr>
                        <tr>
          ...
          <tr>
            <td><table width="710" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><img src="<%=imgUrl%>title_04.gif"  /></td>
              </tr>
              <tr>
                <td height="4"></td>
              </tr>
			...
			<tr>
				<td align="left" style="text-align:left;font-weight:bold;">자사  관련 정보
<!--				<span style="color:#ff5a00;">(<%//=arrIssueDataList1.size()%>건)</span>-->
				</td>
			</tr>
...
%>
			...
			<tr>
				<td align="left" style="text-align:left;font-weight:bold;">관계사 관련 정보
<!--				<span style="color:#ff5a00;">(<%//=arrIssueDataList2.size()%>건)</span>-->
				</td>
			</tr>
			<tr><td style="height:5px;"></td></tr>
<%
...
%>
			<tr><td style="height:10px;"></td></tr>
			<tr>
				<td align="left" style="text-align:left;font-weight:bold;">경쟁사 관련 정보
<!--				<span style="color:#ff5a00;">(<%//=arrIssueDataList3.size()%>건)</span>-->
				</td>
			</tr>
			<tr><td style="height:5px;"></td></tr>
<%
...
%>
			<tr><td style="height:10px;"></td></tr>
			<tr>
				<td align="left" style="text-align:left;font-weight:bold;">산업전반 관련 정보
<!--				<span style="color:#ff5a00;">(<%//=arrIssueDataList4.size()%>건)</span>-->
				</td>
			</tr>
			<tr><td style="height:5px;"></td></tr>
<%
