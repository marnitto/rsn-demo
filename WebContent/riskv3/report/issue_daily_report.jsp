...
<td style="height:31px;padding-top:0;padding-right:13px;padding-bottom:0;padding-left:13px;border-top:1px solid #dfdfdf;border-right:1px solid #dfdfdf;border-bottom:1px solid #dfdfdf;border-left:1px solid #dfdfdf;background-color:#ededed">
	...
	<td align="left" style="width:362px;color:#666666;font-size:9pt">본 내용은 <strong style="color:#106b87;text-decoration:underline">대외비</strong>로 <strong style="color:#106b87">보안에 유의</strong>하시기 바랍니다.</td>
	<td align="right">
		<table border="0" cellSpacing="0" cellPadding="0">
		<tr>
		<td style="color:#666666;font-size:9pt"><strong>보고기간</strong></td>
		<td style="padding-left:8px;padding-right:8px;color:#666666;font-size:9pt"><img src="<%=imgUrl%>line_00.gif" alt="|" /></td>
		<td style="color:#666666;font-size:9pt"><%=sdate.replaceAll("-",".")%> <%=pr.getString("stime")%>시 ~ <%=edate.replaceAll("-",".")%> <%=pr.getString("etime")%>시</td>
		</tr>
		</table>
	</td>
	</tr>
...
<td style="padding-top:18px;padding-right:16px;padding-bottom:40px;padding-left:16px;border-right:1px solid #dfdfdf;border-bottom:1px solid #dfdfdf;border-left:1px solid #dfdfdf">
	...
	<td colspan="2" style="padding-top:12px;padding-right:0;padding-bottom:0;padding-left:0;border-top:2px solid #d9d9d9">
		...
		%>
		<tr>
		<td align="center" style="padding-top:10px;padding-bottom:10px;border-bottom:1px solid #e0e0e0;border-left:1px solid #e0e0e0;<%=color%>;font-size:9pt;word-break:break-all"><strong><%=type9%></strong></td>
		<td align="left" style="padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;border-bottom:1px solid #e0e0e0;border-left:1px solid #e0e0e0;color:#666666;font-size:9pt;word-break:break-all"><a href="http://hub.buzzms.co.kr?url=<%=idBean.getId_urlEncoding()%>" target="_blank" style="display:block;color:#666666;text-decoration:none;"><%=idBean.getId_title()%></a></td>
		<td align="center" style="padding-top:10px;padding-bottom:10px;border-bottom:1px solid #e0e0e0;border-left:1px solid #e0e0e0;color:#666666;font-size:9pt;word-break:break-all"><%=idBean.getMd_site_name()%></td>
		<td align="center" style="padding-top:10px;padding-bottom:10px;border-bottom:1px solid #e0e0e0;border-left:1px solid #e0e0e0;color:#666666;font-size:9pt;word-break:break-all"><%=idBean.getMd_date()%></td>
		<td align="center" style="padding-top:10px;padding-bottom:10px;border-bottom:1px solid #e0e0e0;border-left:1px solid #e0e0e0;color:#666666;font-size:9pt;word-break:break-all"></td>
		<td align="center" style="padding-top:10px;padding-bottom:10px;border-right:1px solid #e0e0e0;border-bottom:1px solid #e0e0e0;border-left:1px solid #e0e0e0;color:#666666;font-size:9pt;word-break:break-all"><%=idBean.getMd_same_ct()%></td>
		</tr>
		<% }
		}else{ %>
		<tr>
	...
	<td colspan="2" style="padding-top:10px;padding-bottom:20px;color:#333333;font-size:9pt">
		...
		<td style="padding-top:20px;padding-right:15px;padding-left:15px;border-top:1px solid #d7d7d7;border-right:1px solid #d7d7d7;border-bottom:1px solid #d7d7d7;border-left:1px solid #d7d7d7;background-color:#f1f1f1">
			...
			<tr>
			<td style="padding-top:8px;color:#666666;font-weight:bold;font-size:9pt">
				<ol>
	...
	<td colspan="2" style="padding-top:12px;padding-right:0;padding-bottom:0;padding-left:0;border-top:2px solid #d9d9d9">
		...
		<tr>
		<td align="center" style="padding-top:10px;padding-bottom:10px;border-bottom:1px solid #e0e0e0;border-left:1px solid #e0e0e0;color:#666666;font-size:9pt;word-break:break-all"><%=idBean.getMd_site_name() %></td>
		<td align="left" style="padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;border-bottom:1px solid #e0e0e0;border-left:1px solid #e0e0e0;color:#666666;font-size:9pt;word-break:break-all"><a href="<%=caffeUrl%>" target="_blank" style="display:block;color:#666666;text-decoration:none;"><%=idBean.getId_title()%></a></td>
		<td align="center" style="padding-top:10px;padding-bottom:10px;border-bottom:1px solid #e0e0e0;border-left:1px solid #e0e0e0;color:#666666;font-size:9pt;word-break:break-all"></td>
		<td align="center" style="padding-top:10px;padding-bottom:10px;border-bottom:1px solid #e0e0e0;border-left:1px solid #e0e0e0;color:#666666;font-size:9pt;word-break:break-all"><%=idBean.getMd_date()%></td>
		<td align="center" style="padding-top:10px;padding-bottom:10px;border-bottom:1px solid #e0e0e0;border-left:1px solid #e0e0e0;color:#666666;font-size:9pt;word-break:break-all"><%=idBean.getIc_influence()%></td>
		<td align="center" style="padding-top:10px;padding-bottom:10px;border-right:1px solid #e0e0e0;border-bottom:1px solid #e0e0e0;border-left:1px solid #e0e0e0;color:#666666;font-size:9pt;word-break:break-all"><%=idBean.getMd_same_ct()%></td>
		</tr>
		<%}
			}else{ %>
	...
	<!-- Daily Analysis -->
	<p style="margin-bottom:15px"><img src="<%=imgUrl%>h2_title_03.gif" alt="Daily Analysis" /></p>
	<table border="0" cellSpacing="0" cellPadding="0" width="100%" style="font-family:inherit;color:inherit;font-size:inherit;table-layout:fixed">
	<tbody>
	<tr>
	...
	<td colspan="2" style="padding-bottom:20px;border-top:2px solid #d9d9d9">
		...
		<tbody>
		<tr>
		<td height="30" style="padding-left:16px;border-bottom:1px solid #e1e1e1;background:#f0f0f0"><img src="<%=imgUrl%>bullet_02.gif" alt="." style="vertical-align:middle" /><strong style="color:#333333;font-size:9pt">정보 그룹별 성향</strong></td>
		</tr>
		<tr>
		<td style="padding-top:15px;padding-right:15px;padding-bottom:20px;padding-left:15px">
			<table border="0" cellSpacing="0" cellPadding="0" width="100%" style="font-family:inherit;color:inherit;font-size:inherit;line-height:inherit;table-layout:fixed">
			...
			<td style="padding-right:20px;vertical-align:top">
				...
				<td style="width:58px;border-right:1px solid #dedddd;border-bottom:1px solid #dedddd;background:#eeeeee;color:#386bb4;font-size:9pt;text-align:center;word-break;break-all"><strong>긍정</strong></td>
				<td style="width:58px;border-right:1px solid #dedddd;border-bottom:1px solid #dedddd;background:#eeeeee;color:#c32a29;font-size:9pt;text-align:center;word-break;break-all"><strong>부정</strong></td>
				<td style="border-right:1px solid #dedddd;border-bottom:1px solid #dedddd;background:#eeeeee;color:#6d9031;font-size:9pt;text-align:center;word-break;break-all"><strong>중립</strong></td>
				<td style="width:57px;border-bottom:1px solid #dedddd;background:#eeeeee;color:#666666;font-size:9pt;text-align:center;word-break;break-all"><strong>분야별<br/> 합계</strong></td>
				</tr>
				<%
				if(chartList.size() > 0 ){
					int posTotal = 0;
				...
				%>
				<tr>
				<th style="height:31px;border-right:1px solid #dedddd;border-bottom:1px solid #dedddd;color:#666666;font-size:9pt;font-weight:bold;text-align:center;word-break;break-all"><%=dataMap.get("CATEGORY")%></th>
				<td style="border-right:1px solid #dedddd;border-bottom:1px solid #dedddd;color:#666666;font-size:9pt;font-weight:normal;text-align:center;word-break;break-all"><%=dataMap.get("PCNT")%></td>
				<td style="border-right:1px solid #dedddd;border-bottom:1px solid #dedddd;color:#666666;font-size:9pt;font-weight:normal;text-align:center;word-break;break-all"><%=dataMap.get("NCNT")%></td>
				<td style="border-right:1px solid #dedddd;border-bottom:1px solid #dedddd;color:#666666;font-size:9pt;font-weight:normal;text-align:center;word-break;break-all"><%=dataMap.get("ECNT")%></td>
				<td style="border-bottom:1px solid #dedddd;color:#666666;font-size:9pt;font-weight:bold;text-align:center;word-break;break-all"><%=total%></td>
				</tr>
				<%
					}%>
					<tr>
					...
					<td style="border-right:1px solid #dedddd;border-bottom:1px solid #dedddd;color:#666666;font-size:9pt;font-weight:bold;text-align:center;word-break;break-all"><%=posTotal%></td>
					<td style="border-right:1px solid #dedddd;border-bottom:1px solid #dedddd;color:#666666;font-size:9pt;font-weight:bold;text-align:center;word-break;break-all"><%=negTotal%></td>
					<td style="border-right:1px solid #dedddd;border-bottom:1px solid #dedddd;color:#666666;font-size:9pt;font-weight:bold;text-align:center;word-break;break-all"><%=neuTotal%></td>
					<td style="border-bottom:1px solid #dedddd;color:#666666;font-size:9pt;font-weight:bold;text-align:center;word-break;break-all"><%=posTotal+negTotal+neuTotal%></td>
					</tr>
				<%}else{ %>
				<tr>
	...
	<td colspan="2" style="padding-top:9px;padding-bottom:20px;border-top:2px solid #d9d9d9">
		...
		<td style="padding-top:9px;padding-bottom:9px;border-right:1px solid #dfdedf;border-bottom:1px solid #e8e8e8">
			...
			<tr>
			<td style="width:50px;padding-top:3px;vertical-align:top"><span style="padding-left:11px"><img src="<%=imgUrl%>icon_<%=idBean.getIc_code()%>.gif" alt="<%=alt%>"></span></td>
			<td><a href="<%=caffeUrl%>" target="_blank" style="color:#666666;font-size:9pt;line-height:15px;text-decoration:none;word-break;break-all"><%=idBean.getId_title()%></a></td>
			</tr>
			</tbody>
			</table>
		</td>
