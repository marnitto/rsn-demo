...
<title>Namo CrossEditor : Admin</title>
	<script type="text/javascript"> var pe_mY = "pe_tq"; </script>
...
<form method="post" id="adminSetForm" name="adminSetForm" action="manager_proc.jsp" onsubmit="return pe_E();">
<div id="pe_Wg">
	<table class="pe_lE">
		<tr>
			<td class="pe_en">
				...
				<table id="Info">
					<tr>
						...
						<font style="font-size:14pt;color:#3e77c1;font-weight:bold;text-decoration:none;"><span id="pe_vk"></span></font></td>
				...
				<table class="pe_hz">
					<tr>
						<td class="pe_Xn">				
							<ul>
								<li class="pe_fB pe_ty"><input type="button" id="setting_base" value="" style="width:110px;height:28px;" class="pe_lI pe_dj" /></li>
								<li class="pe_fB"><input type="button" id="setting_edit" value="" style="width:110px;height:28px;" class="pe_lI pe_dj" /></li><!-- 텝추가 추가 -->
								<li class="pe_fB"><input type="button" id="setting_view" value="" style="width:110px;height:28px;" class="pe_lI pe_dj" /></li>
								<li class="pe_fB"><input type="button" id="setting_ab" value="" style="width:110px;height:28px;" class="pe_lI pe_dj" /></li>
							</ul>
						
						</td>
					</tr>
					<tr>
						<td class="pe_gw pe_ex"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_yo"></span></font></td>
					</tr>
				</table>
			...
			<td class="pe_en">
				<div id="pe_Dz">
					<table class="pe_lU">
						<tr>
							<td>
								<table class="pe_ce"><tr><td class="pe_dx" colspan="3"></td></tr>
								</table>
							 
								<table class="pe_ce">
								
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_uj"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_ui"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_um"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_rB"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
											<input type="text" id="ImageSavePath" class="pe_go" name="ImageSavePath" value="<%=settingValue.get("ImageSavePath")%>" /> ex) http:// www.mysite.com/image
										</td>
									</tr>
									...
									<div id="pe_Gl">
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_uN"></span></b></td>
										<td class="pe_bS"></td>
										<td >
											<table class="pe_ce">
												<tr>
													<td class="pe_bN"> &nbsp;&nbsp;
														<input type="radio" name="encodingStyle" id="pe_wB" value="real" /><span id="pe_td"></span>
												...
												<tr>
													<td class="pe_bN"> &nbsp;&nbsp;
													<input type="radio" name="encodingStyle" id="pe_Dt" value="trans" /><span id="pe_uz"></span>
													</td>
												</tr>
												<tr>
													<td class = "pe_bV" colspan="3"></td>
												...
												<tr>
													<td class="pe_bN"> &nbsp;&nbsp;
														<input type="radio" name="encodingStyle" id="pe_Do" value="random" /><span id="pe_wn"></span>
													</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_yP"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN"> &nbsp;
											<input type="hidden" id="UploadFileSubDir" name ="UploadFileSubDir" value="<%=settingValue.get("UploadFileSubDir")%>" />
											<input type="radio" id="pe_sE" name="pe_BT" value="true" /><label for="pe_sE"><span id="pe_yL"></span></label>&nbsp;&nbsp;
											<input type="radio" id="pe_sF" name="pe_BT" value="false" /><label for="pe_sF"><span id="pe_yK"></span></label>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_sS"></span></b></td>
										<td class="pe_bS"></td>
										<td >
											<table class="pe_ce">
												<tr>
													<td >&nbsp;&nbsp;<span id="pe_rx"></span></td>
													<td class="pe_bS"></td>
													<td class="pe_bN"><input type="text" id="Width" name="Width" class="pe_iH" maxlength="10" value="<%=settingValue.get("Width")%>" />
													px</td>
												</tr>
												<tr>
													<td class = "pe_bV" colspan="3"></td>
												...
												<tr>
													<td >&nbsp;&nbsp;<span id="pe_sx"></span></td>
													<td class="pe_bS"></td>
													<td class="pe_bN"><input type="text" id="Height" name="Height" class="pe_iH" maxlength="10" value="<%=settingValue.get("Height")%>" /> px
													</td>
												</tr>	
											</table>
										</td>
						...
						<tr>
							<td class="pe_gw pe_ex"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_zl"></span></font></td>
						</tr>
						...
						<tr>
							<td>
								...
								<table class="pe_ce">
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_vw"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_xj"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_xX"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_wF"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_xb"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_xf"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_vR"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_yj"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_xL"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_tx"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
											<input type="text" id="DocBaseURL" name="DocBaseURL" class="pe_go" value="<%=settingValue.get("DocBaseURL")%>" /> ex) http://www.mysite.com/doc.html 
										</td>
									</tr>
...
<!--  CE 3 제한설정 -->							
						...
						<tr>
							<td class="pe_gw pe_ex"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_yU"></span></font></td>
						</tr>
						...
						<tr>
							<td>
								...
								<table class="pe_ce">
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_yF"></span></b></td>
										<td class="pe_bS"></td>
										<td>
											<table class="pe_ce">
												<input type="hidden" name="UploadFileExtBlockList" value="<%=settingValue.get("UploadFileExtBlockList")%>" />
												<tr>
													<td class="pe_bN"><input type="checkbox" id="UploadFileExtBlockListChecked" <%=settingValue.get("UploadFileExtBlockListChecked")%>/><span id="pe_lw"></span></td>
												</tr>
												<tr>
													<td class="pe_bN"><textarea id="UploadFileExtBlockListTextarea" cols="70" rows="2"><%=settingValue.get("UploadFileExtBlockListTextarea")%></textarea><br /><span id="pe_CJ"></span></td>
												</tr>	
											</table>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_wt"></span></b></td>
										<td class="pe_bS"></td>
										<td >
											<table class="pe_ce">
												<input type="hidden" name="AttributeBlockList" value="<%=settingValue.get("AttributeBlockList")%>" />
												<tr>
													<td class="pe_bN"><input type="checkbox" id="AttributeBlockListChecked" <%=settingValue.get("AttributeBlockListChecked")%>/><span id="pe_lw"></span></td>
												</tr>
												<tr>
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_vT"></span></b></td>
										<td class="pe_bS"></td>
										<td >
											<table class="pe_ce">
												...
												<input type="hidden" 
												<tr>
													<td class="pe_bN"><input type="checkbox" id="TagBlockListChecked" <%=settingValue.get("TagBlockListChecked")%>/><span id="pe_lw"></span></td>
												</tr>
												<tr>
...
<!-- CE3 템플릿 설정 mwhong 2013.04.01-->
						...
						<tr>
							<td class="pe_gw pe_ex"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_vU"></span></font></td>
						</tr>
						...
						<tr>
							<td>
								...
								<table class="pe_ce" >
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_vJ"></span></b></td>
										<td class="pe_bS"></td>
										<td>
											<table class="pe_ce">
												<input type="hidden" name="Template" id="Template" value="<%=settingValue.get("Template")%>" />
												<tr>
													<td class="pe_bN"><input type="button" id="pe_aaY" value="+" onClick="pe_B(this)"/></td>
													<td class="pe_bN">&nbsp;</td>
													<td class="pe_bN">&nbsp;</td>
												</tr>
											...
											for(int i=0; i<TemplateListArr.length ; i++){
												...
												if(TemplateListArr[i] == null || TemplateListArr[i] == ""){
													...
													%>
														<tr>
															<td><input type="text"  name="pe_CZ"  value="<%=templateName %>" style="width:100px"/></td>
															<td><input type="text"  name="pe_FQ"  value="<%=templateUrl %>" style="width:320px"/></td>
															<td><input type="text"  name="pe_IL"  value="<%=templateEncoding %>" style="width:90px"/><input type="button" value="-" onclick="pe_o(this)"/></td>
					...
					<table class="pe_lU">
						<tr>
							<td>
								...
								<table class="pe_ce">
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_wc"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_Co" class="color{hash:true,valueElement:'FontColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="FontColor" name="FontColor" value="<%=settingValue.get("FontColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_ec">
											<input type="button" class="pe_dY pe_dj" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_Co').color.fromString('#000000');">
											</li>
											</ul></td>
											</tr>
											</table>
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_vH"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_xV"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_xQ"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
									...
									<tr>
										...
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_wO"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN"><input type="checkbox" id="ReturnKeyActionBRChecked" <%=settingValue.get("ReturnKeyActionBRChecked")%>/><label for="ReturnKeyActionBR"><span id="pe_wL"></span></label></td>
									</tr>
									<tr>
										<td class="pe_bV" colspan="3"></td>
									</tr>
								...
								<table class="pe_ce">
									<tr>
										<td class="pe_gw pe_ex"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_yh"></span></font></td>
									</tr>
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_wx"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_CN" class="color{hash:true,valueElement:'ImgLineColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="ImgLineColor" name="ImgLineColor" value="<%=settingValue.get("ImgLineColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_ec">
											<input type="button" class="pe_dY pe_dj" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_CN').color.fromString('#000000');">
											</li>
											</ul></td>
											</tr>
											</table>
								...
								<table class="pe_ce">				
									<tr>
										<td class="pe_gw pe_ex"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_vo"></span></font></td>
									</tr>
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_vV"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_zV" class="color{hash:true,valueElement:'TableLineColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="TableLineColor" name="TableLineColor" value="<%=settingValue.get("TableLineColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_ec">
											<input type="button" class="pe_dY pe_dj" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_zV').color.fromString('#000000');">
											</li>
											</ul></td>
											</tr>
											</table>
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_vp"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_AV" class="color{hash:true,valueElement:'TableBGColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="TableBGColor" name="TableBGColor" value="<%=settingValue.get("TableBGColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_ec">
											<input type="button" class="pe_dY pe_dj" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_AV').color.fromString('#FFFFFF');">
											</li>
											</ul></td>
											</tr>
											</table>
			...
			<td class="pe_en">
				<div id="pe_Ea">
					<table class="pe_lU">
						<tr>
							<td>
								...
								<table class="pe_ce">
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_vq"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_tf"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
											<input type="text" id="Css" name="Css" class="pe_go" value="<%=settingValue.get("Css")%>" />  ex) http://www.mysite.com/common.css 
										</td>
									</tr>
									<tr>
										<td class="pe_bV" colspan="3"></td>
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_xT"></span></b>
										...
										<td >
											<table class="pe_ce">
												<tr>
													<td class="pe_lD">&nbsp;&nbsp;<span id="pe_zo"></span></td>
													<td class="pe_bS"></td>
													<td class="pe_bN">
														<input type="text" id="outlinecolor" name="outlinecolor" class="pe_ly" value="" />  ex) #000000 or black 
													</td>
												</tr>
												<tr>
													<td class="pe_bV" colspan="3"></td>
												...
												<tr>
													<td class="pe_lD">&nbsp;&nbsp;<span id="pe_wY"></span></td>
													<td class="pe_bS"></td>
													<td class="pe_bN">
														<input type="text" id="innerlineColor" name="innerlineColor" class="pe_ly" value="" />
													</td>
												</tr>
												<tr>
													<td class="pe_bV" colspan="3"></td>
												...
												<tr>
													<td class="pe_lD">&nbsp;&nbsp;<span id="pe_we"></span></td>
													<td class="pe_bS"></td>
													<td class="pe_bN">
														<input type="text" id="skinfontColor" name="skinfontColor" class="pe_ly" value="" />
													</td>
												</tr>
												<tr>
													<td class="pe_bV" colspan="3"></td>
												...
												<tr>
													<td class="pe_lD">&nbsp;&nbsp;<span id="pe_vF"></span></td>
													<td class="pe_bS"></td>
													<td class="pe_bN">
														<input type="text" id="toolbarBackgroundColor" name="toolbarBackgroundColor" class="pe_ly" value="" />
													</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_yE"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
											<input type="hidden" id="CreateTab" name ="CreateTab" value="<%=settingValue.get("CreateTab")%>" />
											<input type="checkbox" id="pe_pV" name="pe_mk" value="0" /><label for="pe_pV"><span id="wysiwyg"></span></label>&nbsp;&nbsp;
											<input type="checkbox" id="pe_qv" name="pe_mk" value="1" /><label for="pe_qv"><span id="html"></span></label>&nbsp;&nbsp;
											<input type="checkbox" id="pe_pW" name="pe_mk" value="2" /><label for="pe_pW"><span id="preview"></span></label>
										</td>
									</tr>
								</table>
						...
						<tr>
							<td class="pe_gw pe_ex"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_vG"></span></font></td>
						</tr>
						<tr>
							<td>
								<table class="pe_ce"><tr><td class="pe_dx" colspan="3"></td></tr>
								...
								<table class="pe_ce">
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_xu"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
						...
						<table class="pe_hz">
							<tr>
								<td>
									<table class="pe_ce">
										<tr>
											<td class="pe_bV" colspan="5"></td>
										</tr>
										<tr>
											<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_yt"></span></b></td>
											<td class="pe_bS"></td>
											<td>
												<table class="pe_ce">
													<tr>
														<td class="pe_mf" >&nbsp;&nbsp;<span id="pe_xs"></span></td>
														<td class="pe_bS"></td>
														<td class="pe_bN">
															<input type="text" id="AdminPageUserMenuIdInput" name="AdminPageUserMenuIdInput" class="pe_go" value="" /> 
														</td>
													</tr>
													<tr>
														<td class="pe_bV" colspan="3"></td>
													...
													<tr>
														<td class="pe_mf">&nbsp;&nbsp;<span id="pe_wV"></span></td>
														<td class="pe_bS"></td>
														<td class="pe_bN">
															<input type="radio" name="AdminPageUserMenuPlayKindRadio" id="pe_us" value="function" /><label for="pe_us"><span id="pe_xk"></span></label>&nbsp;&nbsp;<input type="radio" name="AdminPageUserMenuPlayKindRadio" id="pe_tT" value="plugin" /><label for="pe_tT"><span id="pe_xc"></span></label>
														</td>
													</tr>
													<tr>
														<td class="pe_bV" colspan="3"></td>
													...
													<tr>
														<td class="pe_mf">&nbsp;&nbsp;<span id="pe_xm"></span></td>
														<td class="pe_bS"></td>
														<td class="pe_bN" height="50px">
															<input type="text" id="AdminPageUserMenuButtonImgPathInput" name="AdminPageUserMenuButtonImgPathInput" class="pe_go" value="" />
													...
													<tr>
														<td class="pe_mf">&nbsp;&nbsp;<span id="pe_xO"></span></td>
														<td class="pe_bS"></td>
														<td class="pe_bN">	
															<input type="text" id="AdminPageUserMenuTitleInput" name="AdminPageUserMenuTitleInput" class="pe_go" value="" />
														</td>
													</tr>
												</table>
											</td>
											<td class="pe_bS"></td>
											<td style="text-align:center;vertical-align:middle;"><input type="button" id="pe_rr" value="" class="" style="width:60px;height:60px;"/>
											</td>
										</tr>
										<tr>
											<td class="pe_bV" colspan="5"></td>
										...
										<tr>
											<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_xG"></span></b></td>
											<td class="pe_bS"></td>
					...
					<div id = "pe_ce">
						...
						<table class="pe_hz">	
							<tr>
								<td id="pe_yb" class="pe_ex">
									
									<table>
										<tr>
											<td id="pe_UL">
												<span id="pe_xz"></span>: <br>
												<div id="pe_FC" >
													<span id="pe_oX"></span> <br> 
													<span id="pe_ti"></span><br>
													<span id="pe_uH"></span><br>
												</div>
											</td>
											<td id="pe_RU">
											<span id="pe_zs"></span>:<br>
												<div id="pe_DR" ></div>
											</td> 
											<td valign="bottom">
												<ul style="margin:0 auto;width:340px;">
													<li class="pe_ec">
														<input type="button" id="spacebar" value="" class="pe_dY pe_dj" style="width:80px;height:26px;" />
													</li>
													<li class="pe_ec"><input type="button" id="space" value="" class="pe_dY pe_dj" style="width:68px;height:26px;"></li>
													<li class="pe_ec"><input type="button" id="enter" value="" class="pe_dY pe_dj" style="width:66px;height:26px;"></li>
												</ul>
											</td>
										</tr>
										<tr>
					...
					<table class="pe_lU">
						<tr>
							<td>
								...
								<table class="pe_ce">
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_xi"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
											<input type="text" id="DocTitle" name="DocTitle" class="pe_go" value="<%=settingValue.get("DocTitle")%>" />
										</td>
									</tr>
									<tr>
										<td class="pe_bV" colspan="3"></td>
									...
									<tr>
										<td class="pe_cb">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_ys"></span></b></td>
										<td class="pe_bS"></td>
										<td class="pe_bN">
											<input type="hidden" id="AccessibilityOption" name ="AccessibilityOption" value="<%=settingValue.get("AccessibilityOption")%>" />
											<input type="radio" id="pe_uy" name="pe_qI" value="0" /><label for="pe_uy"><span id="pe_yC"></span></label>&nbsp;&nbsp;
											<input type="radio" id="pe_va" name="pe_qI" value="1" /><label for="pe_va"><span id="pe_yn"></span></label>&nbsp;&nbsp;
											<input type="radio" id="pe_uU" name="pe_qI" value="2" /><label for="pe_uU"><span id="pe_yi"></span></label>
										</td>
									</tr>
									<tr>
										<td class="pe_bV" colspan="3"></td>
