...
<%
	...
	if(check){
		result_sc = "<script type='text/javascript' language='javascript'>alert(pe_bF.pe_oW); window.document.location.href='manager_setting.jsp?Tab=" + detectXSSEx(request.getParameter("Tab")) + "';</script>";
	}
	else{
		result_sc = "<script>alert(pe_bF.pe_lg+'" + fileName + "');  history.back();</script> ";
	}
