...
<%
	...
	if(encrypt.equals(u_pass))
	{
			...
			{
				session.invalidate(); 
				result_sc = "<script>alert(pe_bF.pe_oW); window.document.location.href='../index.html';</script>";
			}
			else
			{
		...
		result_sc = "<script>alert(pe_bF.pe_oN);location.href='account_setting.jsp';</script>";
	}
