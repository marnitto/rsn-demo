...
function calendar_template_main_below() {
	...
	+'</tr>'
    +'<tr>'
    +'<td align="center" class="menu_black" style="cursor:pointer" onclick="calendar_set_doday();">Today</td>'
    +'<td align="center" class="menu_black" style="cursor:pointer" onclick="calendar_close();">Close</td>'
    +'</tr>'
    +'</table></td>'
    +'</tr>'
    +'</table>';
