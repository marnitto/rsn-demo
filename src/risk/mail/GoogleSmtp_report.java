...
public class GoogleSmtp_report{
    ...
    public GoogleSmtp_report(){
		log = new Log();
    }
    
    public void setSmtpHost(String fromaddr){
    	
    	String username = fromaddr;
    	if(username.equals("")){
    		username = "daegu@buzzms.co.kr";
    	}
        ...
        //auth = new MyAuthenticator(username, "samsungfire2025");
    ...
    */
	public boolean sendmessage_report(String toaddr, String subject, String body, boolean ishtml){
    	return sendmessage_report(toaddr,"", subject,body, ishtml);
    }
	...
	*	@return		true - 성공, false - 실패
    */
    public boolean sendmessage_report(String toaddr, String fromaddr, String subject, String body, boolean ishtml){
